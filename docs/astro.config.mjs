    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: "Soft Delete",
          items: [
            enterpriseEntry("SoftDeleteSetup", "Setting up"),
            enterpriseEntry("SoftDeleteButton"),
            enterpriseEntry("BulkSoftDeleteButton"),
            enterpriseEntry("DeletedRecordsList"),
            raCoreEntry("DeletedRecordsListBase"),
            raCoreEntry("ShowDeletedBase"),
            raCoreEntry("DeletedRecordRepresentation"),
            enterpriseEntry("RestoreButton"),
            enterpriseEntry("BulkRestoreButton"),
            raCoreEntry("addSoftDeleteBasedOnResource"),
            raCoreEntry("addSoftDeleteInPlace"),
            raCoreEntry("useSoftDelete"),
            raCoreEntry("useSoftDeleteMany"),
            raCoreEntry("useGetListDeleted"),
            raCoreEntry("useGetOneDeleted"),
            raCoreEntry("useRestoreMany"),
            raCoreEntry("useRestoreOne"),
            raCoreEntry("useHardDelete"),
            raCoreEntry("useHardDeleteMany"),
            raCoreEntry("useDeletedRecordsListController"),
          ],
        },
        {
          label: "Misc",
