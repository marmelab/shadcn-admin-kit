...
describe("EditGuesser", () => {
  ...
  it("should render the default empty message when no record is available", async () => {
    const screen = render(<EditGuesser />, { wrapper: TestWrapper });
  ...
  it("should render a custom empty element when provided", async () => {
    const screen = render(<EditGuesser empty={<div>Custom empty</div>} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should not render an empty element when empty is false", async () => {
    const screen = render(<EditGuesser empty={false} />, {
      wrapper: TestWrapper,
    });
